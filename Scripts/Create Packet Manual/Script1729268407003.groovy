...
WebUI.sendKeys(findTestObject('Create Packet/Page_MTR Web/svg_Next_lucide lucide-chevron-down'), Keys.chord(Keys.ARROW_UP))
...
WebUI.click(findTestObject('Create Packet/CP manual/Page_MTR Web/add btn'))
...
WebUI.click(findTestObject('Create Packet/CP manual/Page_MTR Web/button_Generate'))
